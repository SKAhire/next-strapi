      ...
      <div className="h-full bg-gray-100 rounded-2xl">
        ...
        <div className="p-2">
          ...
          <p className="text-sm text-gray-500 font-bold">
            {data.attributes.description.slice(0, 160)}...
          </p>
          <div className="flex flex-wrap md:justify-center -m-2">
            <div className="w-full md:w-auto p-2 my-6">
              <Link
                className="block w-full px-12 py-3.5 text-lg text-center text-white font-bold hover:bg-purple-500 bg-gray-900  focus:ring-4 focus:ring-gray-600 rounded-full"
...
function RestaurantList(props) {
  ...
  if (data.restaurants.data && data.restaurants.data.length) {
    ...
    if (searchQuery.length != 0) {
      ...
      return (
        <h1 className="text-center h-[70vh] bg-white pt-10">
